  ...
  return (
    <main className="h-[calc(100vh-7rem)] flex justify-center items-center mx-auto py-20">
      <section className="grid grid-cols-2 gap-4 m-2">
        <div className="p-6 border  bg-babyblue border-babyblue rounded-[12px] flex flex-col gap-1 col-span-1 row-span-1 justify-center items-center">
        ...
        <div className="p-6 border  bg-babyblue border-babyblue rounded-[12px] flex flex-col gap-1 col-span-2 row-span-1">
        <span className="text-[1rem] md:text-[2rem] text-white py-2">
            Servicios
          </span>
